<?php
define('C_REST_CLIENT_ID','local.688968da7cecd5.54025987');//Application ID
define('C_REST_CLIENT_SECRET','1M06xQXXdOfbclJofwIlG3rWOnBClz50DM7S4QNonDhG7NOiBh');//Application key
// or
